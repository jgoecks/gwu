...
sub usage {
  print q(Usage: perl filterSAM3.pl  <infile1>  <infile2>  <infile3>  <infile4>  <outfile>  <infile5>  <logfile>
  Required:
    ...
    <infile3>  File listing alternative mapping locations and whether putative primers
                 are exact/close (1) or way off (0) (produced by checkAltMapping4.pl)
    <infile4>  Input SAM file containing mapping information
    <outfile>  Output SAM file
  Optional:
    <infile5>  File containing realignment info (produced by alignLengthVars6.pl)
